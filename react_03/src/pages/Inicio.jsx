...
import inicio_1 from "../assets/img/inicio_1.jpg"
import inicio_2 from "../assets/img/inicio_2.jpg"
import inicio_3 from "../assets/img/inicio_3.jpg"
      ...
      <div className="container">
                ...
                <div className="row">
                    ...
                    <div className="col-md-6">
                        <img src={inicio_1} alt="" className="img-fluid img-thumbnail" />
                    </div>
                </div>
                <hr className="my-4"/>
                <div className="row">
                    <div className="col-md-6">
                        <img src={inicio_2} alt="" className="img-fluid" />
                    </div>
                    <div className="col-md-6">
                ...
                <div className="row">
                    ...
                    <div className="col-md-6">
                        <img src={inicio_3} alt="" className="img-fluid" />
                    </div>
                </div>
                   <hr className="my-4"/>
            </div>
